	            ...
	            while(true) {
	                ...
	                try {
	                    ...
	                    synchronized (SocketServer1.xWait) {
	                        SocketServer1.LOGGER.info("这次没有从底层接收到任何TCP连接，等待1000毫秒，模拟事件X的处理时间");
	                        SocketServer1.xWait.wait(1000);
	                    }
	                    continue;
	                }
	        ...
	        try {
	            ...
	            BIORead:while(true) {
	                try {
	                    ...
	                    //      主线程在这里又可以做一些事情，记为Y
	                    //===========================================================
	                    SocketServerThread.LOGGER.info("这次没有从底层接收到任务数据报文，等待1000毫秒，模拟事件Y的处理时间");
	                    continue;
	                }
	            }
	            //下面打印信息
