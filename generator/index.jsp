	...
	<div class="container login-form">
		<form class="form-horizontal" role="form" id="form">
			...
			<div class="col-md-4" style="text-align: left;">
	        	<a id="queryInfo" href="#" onclick="initTables();" style="width: 200px;" class="btn btn-lg btn-primary "><span class="fui-check-circle"></span>&nbsp;获取表信息</a>
	        </div>
	        <div class="col-md-4" style="text-align: center;">
	        	<label for="tableNames" class="col-lg-2 control-label">filter</label>
	        	<div class="col-xs-10">
	        	<input id="filter" list="tableList" class="form-control" name="filter" />
					<datalist id ="tableList">
					</datalist>
				</div>
	        </div>
	        <div class="col-md-4" style="text-align: right;">
	        	<a  href="#" onclick="filterTables();" style="width: 200px;" class="btn btn-lg btn-primary "><span class="fui-check-circle"></span>&nbsp;过滤表信息</a>
	        </div>
	        </div>
			<div class="form-group">
